...
const FIELDS = [
  ...
  new Field('matching', ARRAY_COMPARATORS, INCLUDES_COMPARATOR, ['matches', 'match', 'm', 'is matching for', 'is match for', 'matching for', 'matching starship', 'matching starship for', 'ms', 'msf']),
